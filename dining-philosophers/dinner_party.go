...
const NUM_EATING_PHILOSOPHERS int = 2
...
func main() {
	...
	requestChannel := make(chan *Philosopher, NUM_EATING_PHILOSOPHERS)

	eatingChannel := make(chan *Philosopher, NUM_EATING_PHILOSOPHERS)
